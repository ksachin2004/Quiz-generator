      ...
      >
        ...
        {!user && (
          <div className="mt-10 text-center bg-white/80 rounded-xl shadow p-8 max-w-2xl mx-auto">
            <h2 className="text-xl font-semibold text-indigo-700 mb-2">Sign in to unlock full DBMS study material!</h2>
        ...
        <section className="mb-12">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">Normalization</span>
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">ER to Relational</span>
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">ACID Properties</span>
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">Serializability</span>
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">SQL Joins</span>
            <span className="bg-indigo-100 text-indigo-700 px-4 py-2 rounded-full text-sm shadow">Indexing</span>
          </div>
        </section>
